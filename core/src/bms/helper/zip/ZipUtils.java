...
public class ZipUtils {
    ...
    public static void ZiponeFile(String zip,String outfile,String onefile) throws IOException {
 
		File file = new File(zip);
		File outputFile = new File(outfile);
		ZipFile zipFile = new ZipFile(file);
		ZipEntry entry = zipFile.getEntry(onefile);
