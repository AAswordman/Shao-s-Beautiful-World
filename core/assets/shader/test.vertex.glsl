...
void main() {
	...
	#ifdef skinningFlag
		vec4 pos2 = u_worldTrans * skinning * vec4(morph_pos, 1.0);
	#else
		vec4 pos2 = u_worldTrans * vec4(morph_pos, 1.0);
	#endif
	
	v_position = vec3(pos2.xyz) / pos2.w;
	gl_Position = u_projViewTrans * pos2;
